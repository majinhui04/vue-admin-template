    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-main">
                ...
                <a href="https://github.com/ElementUI/element-theme" class="footer-main-link" target="_blank">{{
                    langConfig.theme }}</a>
                <a href="https://github.com/ElementUI/theme-chalk-preview" class="footer-main-link" target="_blank">{{
                    langConfig.preview }}</a>
            ...
            <div class="footer-main">
                ...
                <a href="https://segmentfault.com/t/element-ui" class="footer-main-link"
                   target="_blank">SegmentFault</a>
